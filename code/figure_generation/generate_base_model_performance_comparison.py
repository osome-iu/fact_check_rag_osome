...
OUTPUT_PATH = "../../figures/base_model_performance_comparison.pdf"
...
def create_comprehensive_figure():
    ...
    gs = GridSpec(nrows=2, ncols=2, height_ratios=[0.9, 0.1])

    ax1 = fig.add_subplot(gs[0, :])  # Main performance plot
    ax2 = fig.add_subplot(gs[1, 0])  # Retrieval rank distribution
    ax3 = fig.add_subplot(gs[1, 1])  # Top-k retrieval accuracy
    ...
    plt.tight_layout()
    plt.subplots_adjust(hspace=0.225, wspace=0.4)

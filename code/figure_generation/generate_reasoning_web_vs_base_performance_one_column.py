...
OUTPUT_PATH = "../../figures/reasoning_web_vs_base_performance_one_column.pdf"
...
MODEL_NAME_MAP = {
    ...
    "gpt-4o-search-preview-2025-03-11": "GPT-4o\nSearch",
...
def create_comprehensive_figure():
    ...
    # Add panel labels
    ax1.text(
        -0.25, 1.05, "(a)", transform=ax1.transAxes, fontsize=10, va="top", ha="right"
    )
    ax2.text(
        -0.25, 1.05, "(b)", transform=ax2.transAxes, fontsize=10, va="top", ha="right"
    )
